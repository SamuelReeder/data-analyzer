...
linear_est = tf.estimator.LinearClassifier(feature_columns=feature_columns+derived_feature_columns, loss_reduction=tf.keras.losses.Reduction.SUM)
...
#       dtype=dict, shape=[32] + shape, name='input_tensor')
...
# )
# result.save("saved_model/my_model")
